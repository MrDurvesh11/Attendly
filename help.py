...
class Help:
    def __init__(self,root):
        ...
        title_lbl=Label(self.root,text="Help Desk",font=("times new roman",35,"bold"),bg="white",fg="indigo")
        ...
        img_left=Image.open(r"images/helpdesk2.jpg")
        img_left=img_left.resize((1480,620),Image.ANTIALIAS)
        self.photoimg_left=ImageTk.PhotoImage(img_left)

        f_lbl=Label(f_lbl2,image=self.photoimg_left)
        f_lbl.place(x=25,y=35,width=1480,height=620)
